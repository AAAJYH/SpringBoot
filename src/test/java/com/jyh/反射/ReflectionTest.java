...
public class ReflectionTest{
    ...
    public void testClass() throws ClassNotFoundException {
        ...
        String className="com.jyh.反射.Person";
    ...
    public void testClassLoader() throws ClassNotFoundException {
        ...
        classLoader=Class.forName("com.jyh.反射.ReflectionTest").getClassLoader();
        System.out.println("Class.forName('com.jyh.反射.ReflectionTest').getClassLoader()："+classLoader);
    ...
    /**
     * com.jyh.反射：Reflection(com.jyh.反射)Java被视为动态语言的关键，反射机制允许程序在执行期借助于Reflection API取得任何类的内部信息，并能直接操作任意对象的内部属性及方法
     * Java反射机制主要提供了一下功能：
     *   ·在运行时构造任意一个类的对象
    ...
    public void testMethod() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InstantiationException, InvocationTargetException {
        Class clazz=Class.forName("com.jyh.反射.Person");
